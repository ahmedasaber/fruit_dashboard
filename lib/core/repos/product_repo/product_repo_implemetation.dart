...
import 'package:fruit_dashboard/features/add_product/data/product_model.dart';
...
class ProductRepoImpl implements ProductRepo{
  ...
  @override
  Future<Either<Failure, void>> addProduct(ProductEntity input) async{
    try{
      await databaseService.addData(
        path: BackendEndpoints.addProduct,
        data: ProductModel.fromEntity(input).toMap()
      );
